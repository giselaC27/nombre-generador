...
function NuevoNombreDocumento() {
  ...
  return (
    <div className="bg-celeste-pastel min-h-screen custom-shape-divider-top-1694732587 ">
      <svg
        data-name="Layer 1"
      ...
      <br /> <br />
      <div className="bg-white bg-opacity-80 backdrop-blur-md p-4 max-w-md mx-auto rounded-lg shadow-md">
        <div className="mb-4">
        ...
        <div className="mt-4">
          ...
          <button
            ...
            className="mt-4 p-2 bg-gray-300 hover:bg-gray-400 text-gray-700 hover:text-gray-800 rounded font-bold"
          >
            Restablecer
          </button>
        </div>
